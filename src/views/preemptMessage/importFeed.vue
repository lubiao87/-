<template>
    <div class="selectInput">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
            <!-- 第一个输入框 -->
            <el-form-item>
                <el-input v-model="formInline.code" :placeholder="inputPlaceholder"></el-input>
           </el-form-item>
            <!-- 第二个输入框 -->
            <el-form-item>
                <el-input v-model="formInline.equipmentName" :placeholder="input2Placeholder"></el-input>
           </el-form-item>
            <!-- 时间选择器 -->
