  ...
  >
    ...
    <div class="principalContent">
      ...
      <div class="parinciRepresent">
        <div class="parinci">
          <!-- form表单组件插入 -->
		  <el-row class="demo-autocomplete" style="display: inline-block;top:14px;width: 100%;border:1px solid #000000;">
		    <el-col :span="12" >
		  ...
		  <el-select v-model="sourceType" placeholder="请选择" @change='sourceTypeChange' style="display: inline-block;">
		   <el-option 
