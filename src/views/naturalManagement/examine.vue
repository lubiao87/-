<template>
    <div class="examineDiaLog">
           ...
           <div class="examineNews">
               <ul class="examineUl">
                   ...
                   <li class="examineLi">
                       ...
                       <span class="text">天河花山002微模块</span>
                   </li>
               </ul>
               <ul class="examineUl">
               <li class="examineLi">
                ...
                <div class="examineBalance">
                    ...
                    <p class="passText nowPass">功率申请审核结果：<span>通过</span></p>
                        <div style="margin-top: 24px">
                            <echarts-Bar v-if="hackReset" :charts="chart2" :EchartsId="passEcharts" :formatterText="formatterNumber"></echarts-Bar>
                        </div>
                    </div>
                    ...
                    <div class="passText">
                        规划审核结果：
                        <el-select v-model="majorApproval" placeholder="请选择" style="width: 100px" >
                            <el-option
        ...
        <!-- EIAC登录请求表单 -->
        <div id="EIACForm" v-show="isShowEIACForm" v-html="formStr">
